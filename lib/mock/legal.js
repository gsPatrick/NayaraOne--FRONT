...
export const AMENDMENT_STATUS_LABELS = { DRAFT: "Rascunho", SIGNED: "Assinado" };
export const AMENDMENT_STATUS_TONE = { DRAFT: "warning", SIGNED: "success" };
...
// FIX (homologação 23/09/2026): o enum de status de garantia estava fora de sincronia com a
// API. legal_guarantees.status aceita ACTIVE | RELEASED | CANCELLED — "EXPIRED" nunca existiu
// do lado do servidor. A tela de detalhe oferecia "Expirada" no seletor e escolher essa opção
// falhava sempre com 400 LEGAL_GUARANTEE_VALIDATION.
export const GUARANTEE_STATUS_LABELS = { ACTIVE: "Ativa", RELEASED: "Liberada", CANCELLED: "Cancelada" };
export const GUARANTEE_STATUS_TONE = { ACTIVE: "success", RELEASED: "neutral", CANCELLED: "danger" };
...
export const MEDIA_TYPE_LABELS = { PHOTO: "Foto", VIDEO: "Vídeo" };
export const MEDIA_TYPE_TONE = { PHOTO: "info", VIDEO: "brand" };

export const RESPONSIBLE_PARTY_LABELS = {
  TENANT: "Locatário",
  LANDLORD: "Locador",
  SHARED: "Compartilhado",
  UNDETERMINED: "A apurar",
};
...
// Severidade real, calculada em runtime pela API (legalDeadlines.service.js computeSeverity) —
// OVERDUE|DUE_SOON(≤48h)|NORMAL|DONE. Vem pronta no campo `severity` de GET /legal/deadlines,
// não deve ser recalculada no front.
export const DEADLINE_API_SEVERITY_LABELS = { OVERDUE: "Vencido", DUE_SOON: "Vence em breve", NORMAL: "No prazo", DONE: "Concluído" };
export const DEADLINE_API_SEVERITY_TONE = { OVERDUE: "danger", DUE_SOON: "warning", NORMAL: "info", DONE: "success" };
