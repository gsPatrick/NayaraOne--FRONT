...
export const GROUP_LABELS = {
  ...
  // FIX (homologação 23/09/2026): a API expõe 84 permissões, mas 5 grupos não tinham rótulo
  // aqui e caíam no fallback groupLabel() -> o próprio código cru. A matriz de permissões da
  // tela de Papéis exibia "crm:dashboard", "crm:feedback", "crm:proposals", "crm:tasks" e
  // "settings" como títulos de seção, no meio de seções devidamente traduzidas.
  "crm:dashboard": "CRM — Painel",
  "crm:proposals": "CRM — Propostas",
  "crm:tasks": "CRM — Tarefas",
  "crm:feedback": "CRM — Feedback de visita",
  settings: "Configurações",
  radar: "Radar",
  finance: "Financeiro",
  legal: "Jurídico & Contratos",
  construction: "Obras & Pós-obra",
  audit: "Atividades (auditoria)",
  billing: "Billing & Locação",
};
...
export const GROUP_DESCRIPTIONS = {
  ...
  "crm:dashboard": "Indicadores e painel do funil de CRM.",
  "crm:proposals": "Propostas comerciais enviadas nas oportunidades.",
  "crm:tasks": "Tarefas vinculadas a oportunidades do funil.",
  "crm:feedback": "Feedback registrado após as visitas a imóveis.",
  settings: "Configurações da empresa (cobrança, segurança e integrações).",
  ...
  construction: "Obras, etapas, medições, RDO, orçamento, qualidade e pós-obra.",
  audit: "Trilha de quem fez o quê e quando no sistema.",
  billing: "Cobrança de locação, reajustes, aluguel garantido, antecipação e utilidades.",
};
...
export const ACTION_LABELS = {
  ...
  // "crm:opportunities:export" também não tinha rótulo e aparecia como "export" cru.
  export: "Exportar",
};
